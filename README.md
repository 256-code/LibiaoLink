...
| `技术设计v0.1-选型分析.md` | **技术设计 v0.1（选型分析篇）**：需求基线、规模画像、技术选型对比与结论、待确认问题（v0.1.6 讨论稿） |
| `技术设计v0.2-架构与数据模型.md` | **技术设计 v0.2（架构与数据模型篇）**：总体架构、领域模型与 DDL 草案、流程节点与蓝图、权限模型、文件管道、自动化规则、接口契约（讨论稿） |
